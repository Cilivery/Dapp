...
const style = {
  wrapper: `border-[#38444d] border-b sticky`, // Keeps the border styles unchanged
  header: `py-1 px-3 mt-2 flex items-center bg-white`, // Changed the background to white
